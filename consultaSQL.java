...
public class consultaSQL {
    // Datos de conexión
    private static final String URL = "jdbc:mysql://localhost:3306/neptuno2/Pedro/123456";
    ...
    public static void ejecutarConsulta(Connection conexion, String consulta) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                System.out.println(resultSet.getString("nombrecategoria") + ", " + resultSet.getString("descricion"));
            }
    ...
    public static void main(String[] args) {
        ...
        if (conexion != null) {
            ejecutarConsulta(conexion, "SELECT nombrecategoria, descricion FROM categorias");
        } else {
